...
export interface AgentCardProps {
  ...
  status: AgentStatus;
  lastActivity: string;
  /** When set, the whole card links to an interactive workspace for this agent (e.g. JD Maker's chat). */
  href?: string;
}

export function AgentCard({ name, description, icon: Icon, status, lastActivity, href }: AgentCardProps) {
  const content = (
